Q: In the SCRABBLE Crossword Game, players form words using small tiles, each
...
2: DG, 3: BCMP, 4: FHVWY, 5: K, 8: JX, 10: QZ.) Write a program that
...
Your program should allow any mixture of lower-case and upper-<F9>ase letters in
the word.
